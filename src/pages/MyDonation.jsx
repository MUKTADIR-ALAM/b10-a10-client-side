...
export default function MyDonation() {
  ...
  return (
    <div className="w-fit mx-auto">
      ...
      {
        myDonations.length?<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mx-auto">
        {myDonations.map((donate) => (
          <DonationCard donate={donate} key={donate._id} />
        ))}
      </div>:<p className="w-fit mx-auto">You have no donation contribute</p>
      }
